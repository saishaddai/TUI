# File Explorer TUI (Go + Bubble Tea)

This is the fifth step in the **Go TUI Learning Roadmap**.  
It demonstrates a minimal **Text User Interface (TUI)** application using [Bubble Tea](https://github.com/charmbracelet/bubbletea).

---

## 📌 What It Does
- Navigate through a archives in a given directory
- Navigate through the files and directories
